...
# In the lectures, we saw that we only chose a small amount (4) for the amount of latent features. However, we are using all of the article IDs for the latent features, which is 714
